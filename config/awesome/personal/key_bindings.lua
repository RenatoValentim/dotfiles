...
local globalkeys = gears.table.join(
	...
	awful.key({ modkey_module.modkey, "Control" }, "k", function()
		awful.util.spawn("kitty")
	end, { description = "Open kitty terminal", group = "Terminal" }),
	awful.key({ modkey_module.modkey }, "j", function()
	...
	awful.key({ modkey_module.modkey, "Shift" }, "k", function()
		awful.client.swap.byidx(-1)
	...
	awful.key({ modkey_module.modkey }, "Return", function()
		awful.spawn(terminal_module.terminal)
	end),
	---@diagnostic disable-next-line: undefined-global
	awful.key(
