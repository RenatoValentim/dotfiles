local which_key = {
  ...
  mappings = {
    ...
    p = {
      name = "Packer",
      c = { ":PackerCompile<Return>", "Compile" },
      i = { ":PackerInstall<Return>", "Install" },
      r = { ":lua require('lvim.utils').reload_lv_config()<Return>", "Reload" },
      s = { ":PackerSync<Return>", "Sync" },
      S = { ":PackerStatus<Return>", "Status" },
      u = { ":PackerUpdate<Return>", "Update" },
      l = { ":PackerClean<Return>", "Clean" },
    },
    l = {
      name = "LSP",
    ...
    u = {
      ...
      c = { ":! ", "Terminal commands into the neovim" },
