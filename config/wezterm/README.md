...
- `Leader+c` opens an `fzf` input prompt to create a named tab in the current pane path
- `Leader+t` opens the same prompt and creates the new tab with the default home-path behavior
